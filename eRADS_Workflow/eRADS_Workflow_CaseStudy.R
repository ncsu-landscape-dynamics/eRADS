...
sug_deli = delineate_range(pre_17, coarse_estimation_of_annual_spread_rate = 10000, buffer_size = 5000, road_only = F, road_buffer = 300)
ctd = sug_deli[[1]]
min_surv = sug_deli[[2]]
sug_surv = sug_deli[[3]]
...
density_map = raster(density_map_file)
load("Roads.RData")
risk_map = raster_format(risk_map)
density_map = raster_format(density_map)
host_map = raster("./host.tif")
host_map = raster_format(host_map)
cost_per_survey = 70
sensi= 0.17
