...
```{r DefineFun2}
polya = aggregate(polys, dissolve = TRUE)
polyd <- disaggregate(polya)
polyd2=SpatialPolygonsDataFrame(polyd,data=data.frame(ID=1:length(polyd)))

polyd2=SpatialPolygonsDataFrame(polys2,data=data.frame(ID=1:length(polys2)))
